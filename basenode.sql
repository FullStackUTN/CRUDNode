...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-06-2018 a las 16:44:21
...
INSERT INTO `productos` (`codigo`, `producto`, `descripcion`, `precio`, `imagen`) VALUES
...
--
ALTER TABLE `productos`
  MODIFY `codigo` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1017;
